...
for prospect in prosp_per40_results:
    ...
    print("Per 40 minute comparisons:")
    vorp_comps = {}
    idx = 0
    ...
    print('\n')
    print("Advanced stat comparisons:\n")
    print(college_player['Player'] + '\t\t\t' + str(college_player['PER']) + " PER/" + str(college_player['TS']) + " TS/" + str(college_player['eFG']) + " eFG/" + \
    ...
    for comp in adv_comparables:
        ...
        vorp_comps[comp[0]] = players[comp[0]]['VORP']
        print(comp[0] + '  ' + str(adv_players[comp[0]]['PER']) + " PER/" + str(adv_players[comp[0]]['TS']) + " TS/" + str(adv_players[comp[0]]['eFG']) + " eFG/" + \
    ...
    print("INTERSECTION OF PER40 AND ADVANCED SIMILARITIES: ")
    # Combine two scores
    ...
    for score in combined_scores:
        print('\t' + score[0] + " with a combined similarity score of: " + str(score[1]))
